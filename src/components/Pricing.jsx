...
const Pricing = () => {
  const openModal = (plan, amount) => {
    ...
    document.getElementById('modal-plan').innerText = `Pay for ${plan}`;
    document.getElementById('modal-amount').innerText = `Amount: $${amount}`;
  ...
  return (
    <div className="text-white min-h-screen flex flex-col items-center justify-start py-12 px-6 bg-gradient-to-br from-[#0e0b1b] to-[#1e1632]">

      <h1 className="text-4xl md:text-6xl font-bold mb-4 text-center gold font-[Cinzel_Display]">
        Kairah Studio Plans
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-7xl w-full px-2">
        ...
        <div className="card">
          ...
          <h2 className="text-2xl font-semibold mb-2 gold">Free</h2>
          ...
          <div className="highlight">Kairah Fame Booster: Not included</div>
          <button className="subscribe-btn bg-gray-500 text-white px-5 py-2 rounded-lg w-full" disabled>
            Included
          </button>
        </div>
        ...
        <div className="card">
          ...
          <h2 className="text-2xl font-semibold mb-2 gold">Pro</h2>
          ...
          <div className="highlight">Kairah Fame Booster: Free for 30 days</div>
          <button
            className="subscribe-btn bg-[#D4AF37] hover:bg-[#b9962f] text-black font-semibold px-5 py-2 rounded-lg w-full"
            data-plan="Pro"
        ...
        <div className="card">
          ...
          <h2 className="text-2xl font-semibold mb-2 gold">Diamond</h2>
          ...
          <div className="highlight">Kairah Fame Booster: Free for 6 months</div>
          <button
            className="subscribe-btn bg-[#D4AF37] hover:bg-[#b9962f] text-black font-semibold px-5 py-2 rounded-lg w-full"
            data-plan="Diamond"
        ...
        {/* Cinematic Plan */}
        <div className="card">
          <div className="badge">Cinematic</div>
          <h2 className="text-2xl font-semibold mb-2 gold">Cinematic</h2>
          ...
          <div className="highlight">Kairah Fame Booster: Free permanently</div>
          <button
            className="subscribe-btn bg-[#D4AF37] hover:bg-[#b9962f] text-black font-semibold px-5 py-2 rounded-lg w-full"
            data-plan="Cinematic"
        ...
        {/* Lifetime Plan */}
        <div className="card">
          <div className="badge">Lifetime</div>
          <h2 className="text-2xl font-semibold mb-2 gold">Lifetime</h2>
      ...
      <div id="paymentModal" className="modal">
        ...
        <div className="modal-content">
          <h2 className="text-2xl gold mb-4" id="modal-plan">Pay for Plan</h2>
          <p className="text-gray-300 mb-4" id="modal-amount">Select your payment method</p>
          ...
          <button className="flex items-center justify-center gap-2 bg-white p-2 rounded-lg shadow hover:scale-105 transition" onClick={() => pay('Paystack')}>
            <img src="images/paystack.png" alt="Paystack" className="w-6 h-auto"/>
            <span className="text-black font-semibold">Paystack</span>
          </button>
          ...
          <button className="flex items-center justify-center gap-2 bg-white p-2 rounded-lg shadow hover:scale-105 transition" onClick={() => pay('Stripe')}>
            <img src="images/stripe.png" alt="Stripe" className="w-6 h-auto"/>
            <span className="text-black font-semibold">Stripe</span>
          </button>
          ...
          <button className="flex items-center justify-center gap-2 bg-white p-2 rounded-lg shadow hover:scale-105 transition" onClick={() => pay('PayPal')}>
            <img src="images/paypal.png" alt="PayPal" className="w-6 h-auto"/>
            <span className="text-black font-semibold">PayPal</span>
          </button>
          ...
          <button className="flex items-center justify-center gap-2 bg-white p-2 rounded-lg shadow hover:scale-105 transition" onClick={() => pay('Wise')}>
            <img src="images/wise.png" alt="Wise" className="w-6 h-auto"/>
            <span className="text-black font-semibold">Wise</span>
          </button>
          ...
          <button className="flex items-center justify-center gap-2 bg-green-500 p-2 rounded-lg shadow hover:scale-105 transition" onClick={showMpesaNumber}>
            <img src="images/mpesa.png" alt="M-Pesa" className="w-6 h-auto"/>
      ...
      {/* M-Pesa Number Popup */}
      <div id="mpesaPopup" className="modal">
        <div className="modal-backdrop absolute inset-0"></div>
        <div className="modal-content">
          <h2 className="text-2xl gold mb-4">Pay with M-Pesa</h2>
          <p className="text-gray-300 mb-2">Send your payment to this number:</p>
          <div className="flex items-center justify-center gap-2 mb-4">
            <span className="text-white font-bold text-lg" id="mpesaNumber">0113554446</span>
